  ...
  <div class="query-stu">
    ...
    <div v-show="!ifShowDetail">
      ...
      <el-form :inline="true" class="demo-form-inline" size="mini">
        ...
        <el-form-item>
          <el-select
            v-model="form2Query.scoreType"
            placeholder="全部成绩"
            style="width:140px"
          >
            <el-option label="全部成绩" value=""></el-option>
            <el-option
              v-for="opt in scoreList"
              :key="opt.id"
              :label="opt.typeName"
              :value="opt.id"
            ></el-option>
        ...
        <el-form-item>
          <el-input
            v-model="form2Query.keyWorkPlace"
            placeholder="搜索作业题目"
          ></el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      Columns: [
        ...
        { name: "课程名称", value: "SubjectName", width: "180", ifShow: true },
        ...
        { name: "成绩", value: "scoreName", width: "100", ifShow: true },
  ...
  mounted() {
    ...
    if (document.documentElement.clientWidth < 720) {
      ...
      this.Columns = [
        ...
        { name: "姓名", value: "name", width: "80", ifShow: true },
        { name: "班级", value: "className", width: "200", ifShow: false },
        { name: "课程名称", value: "SubjectName", width: "180", ifShow: false },
        ...
        { name: "成绩", value: "scoreName", width: "100", ifShow: false },
        { name: "上传时间", value: "createAt", width: "200", ifShow: false },
        { name: "审核时间", value: "reviewAt", width: "200", ifShow: false },
        { name: "截止日期", value: "DeadLine", width: "200", ifShow: false },
      ];
  ...
  methods: {
    ...
    onQuery() {
      ...
      params.append("scoreType", this.form2Query.scoreType); //成绩类型
      ...
      params.append("keyWorkPlace", this.form2Query.keyWorkPlace); //作业题目
